...
const postTaxPrices = prices.map(function(num){
  var percentToGet = 7;
  var percent = (percentToGet / 100) * num;
  return num / percentToGet
})
...
// // CODE HERE
const totalPopulation = populations.reduce(function(previousValue, currentValue){
...
// // CODE HERE
const myStrongest = monstersInYourPocket.filter(function(pow){
  return pow["CP"] > 200 
})
...
// // CODE HERE
const totals = orders.map(function(price) {
